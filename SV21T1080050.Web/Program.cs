    ...
    private static void Main(string[] args)
    {
        ...
        builder.Services.AddAuthentication(CookieAuthenticationDefaults.AuthenticationScheme)
                .AddCookie(option =>
                {
                    ...
                    option.LoginPath = "/Account/Login";                //URL của trang login
                    option.AccessDeniedPath = "/Account/AccessDenined"; //URL của trang khi người sử dụng không được truy cập
                    option.ExpireTimeSpan = TimeSpan.FromDays(360);     //Khoảng thời gian tồn tại của cookie
                });
